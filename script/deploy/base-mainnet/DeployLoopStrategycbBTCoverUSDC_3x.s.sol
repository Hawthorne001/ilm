...
contract DeployLoopStrategycbBTCoverUSDC_3x_Config is BaseMainnetConstants {
    ...
    // 3x leverage (and 3x price exposure)
    uint256 leverage = USDWadRayMath.usdDiv(300, 100);
    ...
    LoopStrategyConfigCore public cbBTCoverUSDC_3x = LoopStrategyConfigCore({
        ...
        strategyERC20Config: ERC20Config({
            name: "Seamless ILM 3x Loop cbBTC/USDC",
            symbol: "ilm-cbBTC/USDC-3xloop"
        }),
...
contract DeployLoopStrategycbBTCoverUSDC_3x is
    Script,
    DeployHelper,
    DeployLoopStrategycbBTCoverUSDC_3x_Config
{
    function run() public {
        ...
        LoopStrategy strategy = _deployLoopStrategyCore(
            deployerAddress, ISwapper(SWAPPER), cbBTCoverUSDC_3x
        );
